        ...
        <div class="row g-4">
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2">
                        <a href="{{ route('salons.index') }}" class="footer-link">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2">
                        <a href="{{ route('salons.index') }}?service=haircut" class="footer-link">
                            <i class="bi bi-scissors me-1"></i> Haircut
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('salons.index') }}?service=facial" class="footer-link">
                            <i class="bi bi-emoji-smile me-1"></i> Facial
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('salons.index') }}?service=manicure" class="footer-link">
                            <i class="bi bi-hand-index me-1"></i> Manicure
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('salons.index') }}?service=spa" class="footer-link">
