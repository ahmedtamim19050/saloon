    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="details-card">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">${{ number_format($appointment->payment->service_amount ?? 0, 2) }}</span>
                </div>
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">${{ number_format($appointment->payment->tip_amount, 2) }}</span>
                </div>
                @endif
                ...
                <div class="info-row">
                    ...
                    <span class="info-value" style="font-size: 18px; color: #10b981;">
                        ${{ number_format($appointment->payment->total_amount ?? $appointment->payment->amount, 2) }}
                    </span>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="earnings-card">
                ...
                <div class="earnings-breakdown">
                    <div class="earnings-row">
                        ...
                        <span style="font-weight: 600;">${{ number_format($earnings['service_amount'], 2) }}</span>
                    </div>
                    <div class="earnings-row">
                    ...
                    <div class="earnings-row" style="border-top: 2px solid #065f46; padding-top: 10px; margin-top: 10px; font-weight: 700; font-size: 16px;">
                        ...
                        <span>${{ number_format($earnings['total'], 2) }}</span>
                    </div>
                </div>
            </div>
            @endif
            ...
            <div class="salon-info-card">
                <h5 style="color: #92400e; font-weight: 700; margin-bottom: 15px;">
                    <i class="bi bi-building me-2"></i>Salon Information
                </h5>
                
                @if($appointment->salon->logo)
                <img src="{{ asset('storage/' . $appointment->salon->logo) }}" 
                     alt="{{ $appointment->salon->name }}" 
                     class="salon-detail-logo">
                @endif

                <h6 style="color: #78350f; font-weight: 700; margin-bottom: 10px;">
