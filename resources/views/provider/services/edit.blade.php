...
<div class="container-fluid" style="padding: 32px;">
    ...
    <div class="form-header">
        ...
        <h1><i class="bi bi-pencil me-2" style="color: #872341;"></i> Edit Service</h1>
        <p style="color: #6b7280; margin: 0;">Update service details and pricing</p>
    </div>
        ...
        <form action="{{ route('provider.services.update', $service) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select class="form-control-modern @error('category') is-invalid @enderror" 
                    ...
                    <option value="Beard Care" {{ old('category', $service->category) == 'Beard Care' ? 'selected' : '' }}>Beard Care</option>
                    <option value="Skin Care" {{ old('category', $service->category) == 'Skin Care' ? 'selected' : '' }}>Skin Care</option>
                    ...
                    <option value="Coloring" {{ old('category', $service->category) == 'Coloring' ? 'selected' : '' }}>Coloring</option>
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control-modern @error('description') is-invalid @enderror" 
                          ...
                          name="description" 
                          rows="4"
                          placeholder="Describe what's included in this service...">{{ old('description', $service->description) }}</textarea>
