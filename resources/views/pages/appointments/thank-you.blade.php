                        ...
                        <div class="row g-3">
                                ...
                                <div style="padding: 12px; background: white; border-radius: 12px;">
                                    ...
                                    <div style="display: flex; flex-direction: column; gap: 6px;">
                                        ...
                                        <div style="display: flex; justify-content: space-between; align-items: center;">
                                            ...
                                            <span style="font-size: 13px; color: #10b981; font-weight: 600;">৳{{ number_format($service->price, 0) }}</span>
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div style="padding: 16px; background: linear-gradient(135deg, #065f46, #047857); border-radius: 12px; display: flex; justify-content: space-between; align-items: center;">
                                    ...
                                    <span style="font-size: 24px; color: white; font-weight: 800;">৳{{ number_format(session('appointment')->total_amount, 0) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
