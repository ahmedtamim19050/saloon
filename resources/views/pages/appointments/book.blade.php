            ...
            <div class="booking-header-card">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                        @if ($currentSalon && $currentSalon->hasSubdomain())
                            <a href="{{ $currentSalon->subdomain_url }}" class="text-decoration-none"
                                style="color: #6b7280; transition: all 0.3s;"
                                onmouseover="this.style.color='#872341'; this.style.transform='translateX(-3px)'"
                                onmouseout="this.style.color='#6b7280'; this.style.transform='translateX(0)'">
                        ...
                        <div>
                            ...
                            <p style="color: #6b7280; margin: 0; font-size: 15px;">
                                ...
                                @endif
                                @if($currentSalon)
                                    at <strong>{{ $currentSalon->name }}</strong>
                                @endif
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                                ...
                                <form action="{{ route('appointments.store') }}" method="POST" x-data="bookingForm()">
                                    ...
                                    <div class="row g-3 mt-3">
                                        <div class="col-12 col-sm-6">
                                            @if ($provider && $provider->salon && $provider->salon->hasSubdomain())
                                                <a href="{{ $provider->salon->subdomain_url }}/providers/{{ $provider->id }}"
                        ...
                        <div class="col-12 col-lg-4">
                            ...
                            <div class="sidebar-card"
                                ...
                                @if ($provider && $provider->salon && $provider->salon->hasSubdomain())
                                    <div class="mt-3 pt-3" style="border-top: 1px solid rgba(135, 35, 65, 0.1);">
                                        <a href="{{ $provider->salon->subdomain_url }}/providers/{{ $provider->id }}" target="_blank"
                                            class="btn btn-sm w-100"
                                            style="background: white; color: #872341; border: 2px solid #872341; font-weight: 600; padding: 10px; border-radius: 10px; transition: all 0.3s; text-decoration: none; display: inline-block; text-align: center;"
                                            onmouseover="this.style.background='#872341'; this.style.color='white'"
                                            onmouseout="this.style.background='white'; this.style.color='#872341'">
                            ...
                            <!-- Salon Info -->
                            <div class="sidebar-card"
                                style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.03), rgba(37, 99, 235, 0.03)); border: 2px solid rgba(59, 130, 246, 0.1);">
                                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 20px;">
                                    <i class="bi bi-geo-alt-fill" style="font-size: 20px; color: #3b82f6;"></i>
                                    <h3 style="font-size: 18px; font-weight: 700; color: #111827; margin: 0;">Salon
                                        Location</h3>
                                </div>

                                <div class="d-flex flex-column gap-3">
                                    <div class="d-flex gap-3 p-3"
                                        style="background: rgba(255,255,255,0.7); border-radius: 12px; border: 1px solid rgba(59, 130, 246, 0.1);">
                                        <div
                                            style="width: 44px; height: 44px; min-width: 44px; background: linear-gradient(135deg, #3b82f6, #2563eb); border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                                            <i class="bi bi-building" style="color: white; font-size: 20px;"></i>
                                        </div>
                                        <div>
                                            <p
                                                style="font-weight: 700; color: #111827; margin-bottom: 6px; font-size: 16px;">
                                                {{ $provider->salon->name }}</p>
                                            <p
                                                style="font-size: 13px; color: #6b7280; margin-bottom: 2px; line-height: 1.5;">
                                                <i class="bi bi-pin-map me-1" style="color: #3b82f6;"></i>
                                                {{ $provider->salon->address }}
                                            </p>
                                            <p style="font-size: 13px; color: #6b7280; margin: 0;">
                                                {{ $provider->salon->city }}, {{ $provider->salon->state }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex gap-3 align-items-center p-3"
                                        ...
                                        <div>
                                            <p
                                                style="font-size: 12px; color: #6b7280; margin: 0; text-transform: uppercase; letter-spacing: 0.5px;">
                                                Contact</p>
                                            <a href="tel:{{ $provider->salon->phone }}"
                                                ...
                                                onmouseout="this.style.color='#111827'">{{ $provider->salon->phone }}</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-3"
                                        ...
                                        <div class="d-flex gap-2 align-items-start mb-2">
                                            <i class="bi bi-clock-fill"
                                                style="color: #f59e0b; font-size: 18px; margin-top: 2px;"></i>
                                            <div class="flex-grow-1">
                                                <p
                                                    style="font-weight: 700; color: #111827; margin-bottom: 8px; font-size: 14px;">
                                                    Working Hours</p>
                                                <div
                                                    style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
                                                    <span
                                                        style="background: white; padding: 6px 12px; border-radius: 8px; font-size: 14px; font-weight: 600; color: #059669; border: 1px solid rgba(5, 150, 105, 0.2);">
                                                        {{ \Carbon\Carbon::parse($provider->salon->opening_time)->format('g:i A') }}
                                                    </span>
                                                    <span style="color: #6b7280;">to</span>
                                                    <span
                                                        style="background: white; padding: 6px 12px; border-radius: 8px; font-size: 14px; font-weight: 600; color: #dc2626; border: 1px solid rgba(220, 38, 38, 0.2);">
                                                        {{ \Carbon\Carbon::parse($provider->salon->closing_time)->format('g:i A') }}
                                                    </span>
                                                </div>
                                                @if ($provider->salon->working_days && is_array($provider->salon->working_days))
                                                    <div class="mt-2 pt-2"
                                                        style="border-top: 1px solid rgba(251, 191, 36, 0.2);">
                                                        <p
                                                            style="font-size: 12px; color: #92400e; margin: 0; line-height: 1.5;">
                                                            <i class="bi bi-calendar-check me-1"></i>
                                                            <strong>Open Days:</strong>
                                                            {{ ucfirst(implode(', ', $provider->salon->working_days)) }}
                                                        </p>
                                                    </div>
                                                @endif
                                            </div>
