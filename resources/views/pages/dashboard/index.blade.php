                ...
                @foreach($upcomingAppointments as $appointment)
                    <div class="px-6 py-4 hover:bg-gray-50">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="ml-4">
                                <span class="text-lg font-bold text-indigo-600">${{ number_format($appointment->service->price, 2) }}</span>
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="bg-white rounded-lg shadow">
                        ...
                        <div class="px-6 py-4 hover:bg-gray-50">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="ml-4 text-right">
                                    <span class="text-lg font-bold text-gray-900">${{ number_format($appointment->service->price, 2) }}</span>
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <a href="{{ route('salons.index') }}" class="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
