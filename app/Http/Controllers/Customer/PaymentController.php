...
class PaymentController extends Controller
{
    ...
    public function show(Appointment $appointment)
    {
        ...
        $appointment->load(['salon', 'provider', 'services']);
    ...
    public function createCheckoutSession(Request $request, Appointment $appointment)
    {
        ...
        // Load appointment relationships
        $appointment->load(['salon', 'services']);
            ...
            $session = StripeSession::create([
                ...
                'line_items' => [[
                    'price_data' => [
                        ...
                        'product_data' => [
                            'name' => 'Appointment Payment - ' . $appointment->salon->salon_name,
                            'description' => 'Services: ' . $appointment->services->pluck('service_name')->join(', '),
                            'images' => [$appointment->salon->logo ? asset('storage/' . $appointment->salon->logo) : ''],
                        ],
                    ],
                    'quantity' => 1,
                ]],
