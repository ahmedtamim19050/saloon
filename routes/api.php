...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Salon Routes
    Route::prefix('salon')->middleware('role:salon')->group(function () {
        Route::get('/statistics', [SalonController::class, 'statistics']);
        Route::get('/providers', [SalonController::class, 'providers']);
        Route::get('/appointments', [SalonController::class, 'appointments']);
